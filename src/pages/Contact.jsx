        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Get in touch with us for any questions, support, or feedback about our venue booking system.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="glass-card no-mobile-backdrop p-8 rounded-3xl shadow-2xl flex flex-col justify-between h-full">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  The future of venue booking is here. Experience seamless,
                  intelligent, and interactive venue management.
                </p>
              </div>
            ...
            <div className="glass-card no-mobile-backdrop p-8 rounded-3xl shadow-2xl">
              ...
              <div className="space-y-4">
                <Link to="/venues" className="flex items-center gap-3 text-gray-600 hover:text-blue-600 transition-colors p-3 rounded-xl hover:bg-blue-50">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                  </svg>
                  <span className="font-medium">Venues</span>
                </Link>
                <Link to="/book" className="flex items-center gap-3 text-gray-600 hover:text-blue-600 transition-colors p-3 rounded-xl hover:bg-blue-50">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  <span className="font-medium">Book Now</span>
                </Link>
                <Link to="/events" className="flex items-center gap-3 text-gray-600 hover:text-blue-600 transition-colors p-3 rounded-xl hover:bg-blue-50">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  <span className="font-medium">Events</span>
                </Link>
                <Link to="/bookings" className="flex items-center gap-3 text-gray-600 hover:text-blue-600 transition-colors p-3 rounded-xl hover:bg-blue-50">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="glass-card no-mobile-backdrop p-8 rounded-3xl shadow-2xl">
              ...
              <div className="space-y-4">
                <Link to="/faq" className="flex items-center gap-3 text-gray-600 hover:text-blue-600 transition-colors p-3 rounded-xl hover:bg-blue-50">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="font-medium">FAQ</span>
                </Link>
                <Link to="/contact" className="flex items-center gap-3 text-gray-600 hover:text-blue-600 transition-colors p-3 rounded-xl hover:bg-blue-50">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span className="font-medium">Contact Us</span>
                </Link>
                <Link to="/privacy-policy" className="flex items-center gap-3 text-gray-600 hover:text-blue-600 transition-colors p-3 rounded-xl hover:bg-blue-50">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                  <span className="font-medium">Privacy Policy</span>
                </Link>
                <Link to="/terms-of-service" className="flex items-center gap-3 text-gray-600 hover:text-blue-600 transition-colors p-3 rounded-xl hover:bg-blue-50">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
