        ...
        <div className="max-w-6xl mx-auto">
          ...
          <section className="border-l-4 border-indigo-500 pl-4 sm:pl-6 bg-indigo-50 rounded-r-lg py-4 pr-4 sm:pr-6">
            ...
            <p className="text-sm sm:text-base text-[#60758a] leading-relaxed">
              By accessing and using MSEC Connect, you accept and agree to be bound by the terms and provisions of this agreement. If you do not agree to these terms, please do not use our platform.
            </p>
          </section>
          ...
          <section className="border-l-4 border-green-500 pl-4 sm:pl-6">
            <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-[#111418]">3. Booking Rules and Guidelines</h2>
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl p-4 sm:p-5">
                ...
                <div className="grid gap-3">
                  <div className="flex items-start gap-3 bg-white p-3 rounded-lg">
                    ...
                    <span className="text-sm sm:text-base text-[#60758a]">Bookings must be made at least 24 hours in advance</span>
                  </div>
                  <div className="flex items-start gap-3 bg-white p-3 rounded-lg">
                    <span className="text-green-600 font-bold">2.</span>
                    <span className="text-sm sm:text-base text-[#60758a]">All bookings are subject to approval by administrators</span>
                  </div>
                  <div className="flex items-start gap-3 bg-white p-3 rounded-lg">
                    <span className="text-green-600 font-bold">3.</span>
                    <span className="text-sm sm:text-base text-[#60758a]">Provide accurate information about event purpose and attendees</span>
                  </div>
                  <div className="flex items-start gap-3 bg-white p-3 rounded-lg">
                    <span className="text-green-600 font-bold">4.</span>
                    <span className="text-sm sm:text-base text-[#60758a]">Cancel bookings at least 12 hours in advance if plans change</span>
                  </div>
                </div>
              </div>
              <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 sm:p-5">
                ...
                <div className="space-y-3">
                  <div className="bg-white p-4 rounded-lg border-l-4 border-purple-500">
                    ...
                    <p className="text-xs text-[#60758a]">Top priority for all bookings</p>
                  </div>
                  <div className="bg-white p-4 rounded-lg border-l-4 border-blue-400">
                    ...
                    <p className="text-xs text-[#60758a]">Can override regular user bookings</p>
                  </div>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-sm sm:text-base text-[#60758a]">
              ...
              <li>Book venues for unauthorized purposes</li>
              <li>Damage or misuse venue facilities</li>
              <li>Interfere with other users' bookings</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-sm sm:text-base text-[#60758a]">
              <li>Users can cancel their bookings through the platform</li>
              <li>Administrators reserve the right to cancel any booking</li>
              <li>Venue reassignments may occur due to maintenance or priority events</li>
              <li>Users will be notified of any changes to their bookings</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-sm sm:text-base text-[#60758a]">
              <li>Users must vacate the venue within the booked time slot</li>
              <li>Leave the venue clean and organized</li>
              <li>Report any damages or issues immediately</li>
              <li>Do not exceed the venue capacity</li>
              <li>Follow all safety regulations and guidelines</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-sm sm:text-base text-[#60758a] leading-relaxed">
              MSEC Connect is provided "as is" without warranties of any kind. We are not liable for any damages arising from the use or inability to use the platform, including but not limited to booking conflicts, cancellations, or venue unavailability.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm sm:text-base text-[#60758a] leading-relaxed">
              All content on MSEC Connect, including text, graphics, logos, and software, is the property of Meenakshi Sundararajan Engineering College and is protected by copyright and other intellectual property laws.
            </p>
          </section>
          ...
          <section className="border-l-4 border-indigo-500 pl-4 sm:pl-6">
            ...
            <div className="rounded-xl no-mobile-backdrop p-5 sm:p-6 shadow-lg bg-white/10 border border-white/10 backdrop-blur-md">
              <div className="flex items-center gap-3 mb-3">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-[#3d99f5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <p className="text-sm sm:text-base font-medium text-[#111418]">Email: support@msecconnect.edu</p>
              </div>
