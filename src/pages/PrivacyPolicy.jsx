        ...
        <div className="max-w-6xl mx-auto">
          ...
          <section className="border-l-4 border-blue-500 pl-4 sm:pl-6">
            ...
            <p className="text-sm sm:text-base text-[#60758a] leading-relaxed">
              MSEC Connect ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our venue booking and event management platform.
            </p>
          </section>
          ...
          <section className="border-l-4 border-green-500 pl-4 sm:pl-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 p-4 sm:p-5 rounded-xl">
                <h3 className="text-lg sm:text-xl font-semibold mb-2 text-blue-900">Booking Information</h3>
                <ul className="list-disc list-inside space-y-2 text-sm sm:text-base text-[#60758a]">
                  <li>Venue bookings and event details</li>
                  <li>Event purpose and category</li>
          ...
          <section className="border-l-4 border-purple-500 pl-4 sm:pl-6">
            ...
            <div className="bg-purple-50 p-4 sm:p-5 rounded-xl">
              <ul className="list-disc list-inside space-y-2 text-sm sm:text-base text-[#60758a]">
                ...
                <li>Manage event schedules and prevent conflicts</li>
                <li>Communicate with users about their bookings</li>
