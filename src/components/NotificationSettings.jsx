...
function NotificationSettings() {
  ...
  const handleTestNotification = async () => {
    await showNotification('Test Notification', {
      body: 'This is a test notification from MSEC Connect',
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            {!subscribed ? (
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-[#3d99f5] hover:bg-[#2b87e3] text-white text-sm sm:text-base font-semibold rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
                  <>
              ...
              <>
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-[#3d99f5] hover:bg-[#2b87e3] text-white text-sm sm:text-base font-semibold rounded-xl transition-colors"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
